        ...
        <>
            ...
            >
                <section className="content">
                    <h1>Desarrollo web y React</h1>
                    <div className="intro">
                        <div align="center" className="hero-image">
                            <img
                        ...
                        <div className="theme-intro">
                            <h3>
                                Bienvenido a este proyecto sobre desarrollo Web
                                :)
                            </h3>
                            <p>
                                Mi nombre es Miguel Hernández, Frontend
                                Developer con ReactJS⚛️ con interes por la
                                optmización y accesibilidad web. En esta página
                                puedes encontrar contenido sobre desarrollo web.
                            </p>
                    ...
                    <article className="theme-summary">
                        ...
                        <p>
                            Es una pequeña documentación sobre las tecnologías
                            como: HTML, CSS y JavaScript que enseña no solo las
                            etiquetas, estilos o las API's básicas sino también
                            las herramientas que son realmente útil en el
                            desarrollo web:
                        </p>
                        <ul className="some-theme">
                            ...
                            <li>Que es el DOM exactamente?</li>
                            <li>
                                Patrones de diseño: Observer, Prototype,
                                Singleton, etc
                            </li>
                            <li>Hoisting y el Event Loop</li>
                            <li>
                                POO en JavaScript, Añadiendo tipado con
                                TypeScript
                            </li>
                            <li>Promesas, asincronismo y performance.</li>
                            <li>
                                API como: Navigator, Uso Fetch en profundidad,
                                PWA, SPA
                            </li>
                            <li>
